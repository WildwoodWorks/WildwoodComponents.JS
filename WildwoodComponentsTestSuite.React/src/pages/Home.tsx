  ...
  return (
    <div className="page">
      ...
      <div className="status-card">
        ...
        <ul>
          <li>
            <strong>Authentication</strong> — Login, register, 2FA, password reset, OAuth
          </li>
          <li>
            <strong>Notifications</strong> — Toast notification queue
          </li>
          <li>
            <strong>Theme</strong> — Theme switching and CSS variables
          </li>
          <li>
            <strong>Two-Factor</strong> — 2FA enrollment, recovery codes, trusted devices
          </li>
          <li>
            <strong>Token Registration</strong> — Invitation-based registration
          </li>
          <li>
            <strong>Disclaimer</strong> — Pending disclaimers and acceptance
          </li>
          <li>
            <strong>App Tier</strong> — Tier comparison and selection
          </li>
          <li>
