...
export interface UseAuthReturn {
  ...
  resetPassword: (newPassword: string, confirmPassword: string, appId: string, resetToken?: string) => Promise<boolean>;
...
export function useAuth(): UseAuthReturn {
  ...
  const resetPassword = useCallback(
    async (newPassword: string, confirmPassword: string, appId: string, resetToken?: string) => {
      return client.auth.resetPassword(newPassword, confirmPassword, appId, resetToken);
    },
    [client],
  );
