...
describe('@wildwood/react exports', () => {
  // Provider
  it('exports WildwoodProvider', () => {
    expect(WildwoodReact.WildwoodProvider).toBeDefined();
  });

  // Hooks
  it('exports useWildwood', () => {
    expect(WildwoodReact.useWildwood).toBeDefined();
  });
  it('exports useAuth', () => {
    expect(WildwoodReact.useAuth).toBeDefined();
  });
  it('exports useSession', () => {
    expect(WildwoodReact.useSession).toBeDefined();
  });
  it('exports useAI', () => {
    expect(WildwoodReact.useAI).toBeDefined();
  });
  it('exports useMessaging', () => {
    expect(WildwoodReact.useMessaging).toBeDefined();
  });
  ...
  it('exports useCaptcha', () => {
    expect(WildwoodReact.useCaptcha).toBeDefined();
  });
  it('exports useWildwoodComponent', () => {
    expect(WildwoodReact.useWildwoodComponent).toBeDefined();
  });
  it('exports usePlatformDetection', () => {
    expect(WildwoodReact.usePlatformDetection).toBeDefined();
  });

  // Components
  it('exports AuthenticationComponent', () => {
    expect(WildwoodReact.AuthenticationComponent).toBeDefined();
  });
  it('exports AIChatComponent', () => {
    expect(WildwoodReact.AIChatComponent).toBeDefined();
  });
  ...
  it('exports PaymentComponent', () => {
    expect(WildwoodReact.PaymentComponent).toBeDefined();
  });
  ...
  it('exports NotificationToastComponent', () => {
    expect(WildwoodReact.NotificationToastComponent).toBeDefined();
  });
  it('exports TwoFactorSettingsComponent', () => {
    expect(WildwoodReact.TwoFactorSettingsComponent).toBeDefined();
  });
  ...
  it('exports ErrorBoundary', () => {
    expect(WildwoodReact.ErrorBoundary).toBeDefined();
  });
});
