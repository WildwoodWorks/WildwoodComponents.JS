...
const createStyles = (theme: WildwoodTheme) =>
  ...
  container: { flex: 1 },
    ...
    retryButton: { borderWidth: 1, borderColor: theme.dangerText, borderRadius: 6, paddingHorizontal: 16, paddingVertical: 8 },
    ...
    limitItem: { backgroundColor: theme.bgPrimary, borderRadius: 10, padding: 16, borderWidth: 1, borderColor: theme.borderColor },
    ...
    upgradeCta: { marginTop: 20, backgroundColor: theme.warningBg, borderRadius: 10, padding: 16, alignItems: 'center' },
    upgradeMessage: { color: theme.warningText, fontSize: 14, textAlign: 'center', marginBottom: 12 },
    upgradeButton: { backgroundColor: theme.primary, borderRadius: theme.borderRadius, paddingVertical: 12, paddingHorizontal: 24 },
